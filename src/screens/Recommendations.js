...
Выдай один рекомендуемый материал каждого типа (книга, статья, подкаст, видео). Не повторяйся. Формат:
{
  "items": [
    {
      "id": "уникальный id",
   ...
   ТРЕБОВАНИЯ: только реально существующие материалы, разная сложность. Не добавляй никакого текста, только JSON.` }], 'Ты LEV — персональный куратор знаний. Рекомендуй только реальные материалы. Отвечай ТОЛЬКО валидным JSON. Язык: русский.', false, 2000 );
