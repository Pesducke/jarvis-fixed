...
const s = StyleSheet.create({
  ...
  label: { fontFamily: Font.sansM, fontSize: 14, color: '#fff' },
  ...
  pillTxt: { fontFamily: Font.mono, fontSize: 11, color: Colors.muted },
  pillTxtOn: { color: Colors.accent },

  secRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10, marginTop: 16 },
  secTxt: { fontFamily: Font.mono, fontSize: 10, color: Colors.muted, textTransform: 'uppercase', letterSpacing: 1.5 },
